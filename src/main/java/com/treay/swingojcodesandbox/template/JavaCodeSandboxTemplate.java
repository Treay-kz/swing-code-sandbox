...
import com.treay.swingojcodesandbox.CodeSandBox;
...
import com.treay.swingojcodesandbox.model.ExecuteMessage;
import com.treay.swingojcodesandbox.model.JudgeInfo;
import com.treay.swingojcodesandbox.model.enums.JudgeInfoMessageEnum;
import com.treay.swingojcodesandbox.utils.ProcessUtils;
...
public abstract class JavaCodeSandboxTemplate implements CodeSandBox {
    ...
    public ExecuteCodeResponse executeCode(ExecuteCodeRequest executeCodeRequest) {
        ...
        try {
            ...
            // 错误处理
            outputResponse = getErrorResponse(message,e);
        } finally {
            //  5. 文件清理
            CompletableFuture.runAsync(() -> {
                boolean del = clearFile(userCodeFile);
                if (!del) {
                    log.error("文件清理失败,文件路径：{}", userCodeFile.getAbsoluteFile());
                }
            });
    ...
    public ExecuteMessage compileFile(File userCodeFile) {
        ...
        try {
            ...
            if (executeMessage.getExitValue() != 0) {
                ...
                throw new RuntimeException(JudgeInfoMessageEnum.COMPILE_ERROR.getValue());
            }
...
//            String runCmd = String.format("java -Xmx256m -Dfile.encoding=UTF-8 -cp %s Main %s", userCodeParentPath, inputArgs);
            ...
            String runCmd = String.format("java -cp %s Main %s -Xmx256m -Dfile.encoding=UTF-8", userCodeParentPath, inputArgs);
     ...
     * @return
     */
    private ExecuteCodeResponse getErrorResponse(String message,Throwable e) {
        ExecuteCodeResponse executeCodeResponse = new ExecuteCodeResponse();
        JudgeInfo judgeInfo = new JudgeInfo();
